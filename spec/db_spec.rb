  ...
  describe Ruhoh::DB do
    ...
    describe "#update" do
      ...
      it "should run the scripts parser when updating :javascripts" do
        Ruhoh::Resources::Javascripts.should_receive(:generate).and_return({'test' => 'hi'})
